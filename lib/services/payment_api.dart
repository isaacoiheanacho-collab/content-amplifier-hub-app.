...
class PaymentAPI {
  static Future<dynamic> checkMaintenanceStatus(int memberId, String token) async {
  ...
  static Future<String> startMaintenancePayment(int memberId, String token) async {
